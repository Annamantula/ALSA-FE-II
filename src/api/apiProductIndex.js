...
export async function updateCartProduct({
  ...
  try {
    const response = await fetch(
      `${APIurl}/cart/guest/${guest_cart_id}/${cart_product_id}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export async function updateUserCartProduct({
  token,
  count,
  user_id,
  product_id,
  ...
  try {
    const response = await fetch(
      `${APIurl}/cart/users/${user_id}/${product_id}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export async function addProductToCart(product_id, cart_id, count) {
  try {
    const response = await fetch(
      `${APIurl}/products/cart/${product_id}/${cart_id}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
